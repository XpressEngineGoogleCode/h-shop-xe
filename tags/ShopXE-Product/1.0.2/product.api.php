<?php
     ...
     * @brief  product 모듈의 View Action에 대한 API 처리
     **/
    ...
    class productAPI extends product {
         ...
         * @brief 공지사항 목록
         **/
        function dispProductNoticeList(&$oModule) {
         ...
         * @brief 컨텐츠 목록
         **/
        function dispProductContentList(&$oModule) {
         ...
         * @brief 카테고리(분류) 목록
         **/
        function dispProductCatogoryList(&$oModule) {
         ...
         * @brief 게시물 보기
         **/
        function dispProductContentView(&$oModule) {
         ...
         * @brief 컨텐츠의 파일 목록
         **/
        function dispProductContentFileList(&$oModule) {
         ...
         * @brief 태그 목록
         **/
        function dispProductTagList(&$oModule) {
         ...
         * @brief 컨텐츠의 코멘트 목록
         **/
        function dispProductContentCommentList(&$oModule) {
