...
function doHideKrZipList(column_name) {
        ...
        var addr1_obj = xGetElementById('purchase_form')[column_name];
        var field_obj = xGetElementById('purchase_form')['_tmp_address_search_'+column_name];
...
function doSelectKrZip(column_name) {
        ...
        var zone_search_obj = xGetElementById('zone_address_search_'+column_name);
        var zone_addr1_obj = xGetElementById('zone_address_1_'+column_name);
        var sel_obj = xGetElementById('purchase_form')['_tmp_address_list_'+column_name];
        var value = sel_obj.options[sel_obj.selectedIndex].value;
        var addr1_obj = xGetElementById('purchase_form')[column_name];
        var addr2_obj = xGetElementById('purchase_form')[column_name+'_1'];
